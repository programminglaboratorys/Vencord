...
export const addExpressionPickerTabButton = (id: string, tab: string, PanelComponent: ExpressionPickerPanelComponent) => ExpressionPickerComponents.set(id, { tab: tab, Component: PanelComponent });
